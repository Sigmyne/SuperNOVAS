...
[
    ...
    [ "Building and installation", "index.html#autotoc_md68", [
      ...
      [ "Build SuperNOVAS using CMake", "index.html#autotoc_md75", null ],
      [ "Install SuperNOVAS via <span class=\"tt\">vcpkg</span>", "index.html#autotoc_md79", null ],
      [ "Linux packages", "index.html#autotoc_md81", null ],
      [ "Homebrew package", "index.html#autotoc_md84", null ],
      [ "Nix package", "index.html#autotoc_md85", null ]
    ] ],
    [ "Celestial coordinate systems (old vs. new)", "index.html#autotoc_md88", null ],
    [ "Example use cases", "index.html#autotoc_md96", [
      [ "Recommendation: set up an ephemeris provider", "index.html#autotoc_md97", null ],
      [ "Pick your flavor (C or C++)", "index.html#autotoc_md100", null ]
    ] ],
    [ "Incorporating Solar-system ephemeris data or services", "index.html#autotoc_md102", [
