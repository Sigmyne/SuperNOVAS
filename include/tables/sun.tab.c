/**
 * This file contains coefficents for the NOVAS C `earth_sub_calc()` function in `solsys3.c`.
 */
...
#define SOLSYS3_SUN_N_TERMS   50

NOVAS_TABLE struct sun_con con[SOLSYS3_SUN_N_TERMS] = { //
